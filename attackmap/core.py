"""ATTACKMAP core — Map findings to MITRE ATT&CK techniques + coverage heatmap."""
...
RULES = [
    ("ATT-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("ATT-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("ATT-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
